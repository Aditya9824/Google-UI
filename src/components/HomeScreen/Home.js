        ...
        <div className="row">
          <div className="col-md-12 home-screen align-items-center justify-content-center">
            <img
              ...
              alt="Google Logo"
            />
            <div className="search-box col border d-flex py-2 justify-content-between align-items-center">
            ...
            <div className="buttons col-mx-4 ml-5 mt-4 align-items-center justify-content-center">
              <input
                type="button"
